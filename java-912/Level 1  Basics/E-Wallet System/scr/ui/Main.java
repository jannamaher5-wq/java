...
public class Main {
    ...
    private static void showMainMenu() {
        System.out.println("\n--- MAIN MENU ---");
        System.out.println("1. Create New model.Account (Sign-Up)");
    ...
    private static void handleSignUp() {
        ...
        try {
            ...
            if (success) {
                System.out.println("✅ model.Account successfully created! You can now login.");
            }
        } catch (Exception e) {
    ...
    private static void handleUserMenu() {
        while (walletService.getLoggedInUser() != null) {
            ...
            System.out.println("4. Show model.Account Balance & Details");
            System.out.println("5. Change Password");

            if (user.isAdmin()) {
                System.out.println("6. [Admin] Display All Accounts");
                System.out.println("7. [Admin] Freeze / Unfreeze model.Account");
            }
    ...
    private static void showAccountDetails(Account acc) {
        ...
        System.out.println("model.Account Type: " + (acc.isAdmin() ? "Administrator" : "Standard User"));
    }
    ...
    private static void handleToggleStatus() throws Exception {
        ...
        System.out.println("✅ model.Account status updated successfully.");
    }
